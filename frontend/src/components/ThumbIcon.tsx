/** Thumbs-up/down glyph, colored via the shared positive/negative tone tokens (never a fixed emoji color). */
export function ThumbIcon({ tone, size = 13 }: { tone: "positive" | "negative"; size?: number }) {
